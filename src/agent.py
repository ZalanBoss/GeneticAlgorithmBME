...
class Agent:
    def __init__(self, initial_position, chromosome, initial_orientation=np.pi/2):  # Should add genes
    ...
    def convert_sensor_position(self):
    ...
    def handle_input(self):
        self.detection(self.convert_sensor_position())
        self.collide()
